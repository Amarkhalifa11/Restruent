...
@section('content')
    <h1 style="margin-left: 500px"> Edit Product </h1>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('backend.product.update', ['id'=>$product->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" value="{{$product->name}}" class="form-control" id="inputText">
                            </div>
                            @error('name')
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" value="{{$product->category_id}}" name="category_id" >
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" name="description" class="form-control" id="inputText">{{$product->description}}</textarea>
                            </div>
                            @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="price" value="{{$product->price}}" class="form-control" id="inputText">
                            </div>
                            @error('price')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-select" value="{{$product->special}}" name="special" >
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="image" value="{{$product->image}}" class="form-control" id="inputText">
                            </div>
                            @error('image')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
