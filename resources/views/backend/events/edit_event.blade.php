...
@section('content')
    <h1 style="margin-left: 500px"> Edit Event </h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('backend.events.update', ['id'=>$events->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3 mt-5">

                            <label for="inputEmail3" class="col-sm-2 col-form-label">Event title</label>
                            <div class="col-sm-10">
                                <input type="text" value="{{$events->title}}" name="title" class="form-control" id="inputText">
                            </div>
                            @error('title')
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$events->price}}" name="price" class="form-control" id="inputText">
                            </div>
                            @error('price')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text"  name="description" class="form-control" id="inputText">{{$events->description}}</textarea>
                            </div>
                            @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$events->advan1}}" name="advan1" class="form-control" id="inputText">
                            </div>
                            @error('advan1')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="advan2" value="{{$events->advan2}}" class="form-control" id="inputText">
                            </div>
                            @error('advan2')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="advan3" value="{{$events->advan3}}" class="form-control" id="inputText">
                            </div>
                            @error('advan3')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="advan4" value="{{$events->advan4}}" class="form-control" id="inputText">
                            </div>
                            @error('advan4')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
